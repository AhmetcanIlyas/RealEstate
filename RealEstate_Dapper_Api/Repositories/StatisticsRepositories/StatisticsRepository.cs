...
namespace RealEstate_Dapper_Api.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        {
            string query = "Select Avg(Price) From Product where ProductType='2'";
            using (var connection = _context.CreateConnection())
            {
        ...
        {
            string query = "Select Avg(Price) From Product where ProductType='1'";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<decimal>(query);
                return values;
        ...
        {
            string query = "Select Name From Product inner join Employee On Product.EmployeeID=Employee.EmployeeID Group By Name order by Count(*) Desc";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<string>(query);
                return values;
        ...
        public string OldesttBuildingYear()
        {
